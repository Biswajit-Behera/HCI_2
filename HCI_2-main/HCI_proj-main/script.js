...
let typingTimeout;
const text = "The adaptive learning platform for Computer Science Student students and Dyslexia Student!";
...
function speakText() {
  const text = "The adaptive learning platform for Computer Science Students!"; // Text to be spoken
